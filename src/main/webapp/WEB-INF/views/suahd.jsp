...
<body>
    ...
    <div id="content">
     	<div class="container">
      	...
      	<h4 class="text-center">${kiemtra }</h4>
      	<div class="row">
      		<div class="col-md-4 col-md-offset-4">
      			<form  method="post" class="form-horizontal">
      				<div class="form-group">
		        		...
		        		<div class="col-md-8">
		        			<input name="mahd" class="form-control" type="text" value="${hopdong.getMahopdong() }" readonly="false">
		        		</div>
		        	</div>
					<div class="form-group">
					  ...
					  <div class="col-md-8">
						  <select class="form-control" name="nhanvien" id="sel1">
						  		<option value="${hopdong.getNhanvien().getManv() }">${hopdong.getNhanvien().getHonv() } ${hopdong.getNhanvien().getTennv() }(${hopdong.getNhanvien().getManv() })</option>
		        	...
		        	<div class="form-group">
		        		...
		        		<div class="col-md-8">
		        			<input name="loaihd" class="form-control" type="text" value="${hopdong.getLoaihopdong() }">
		        		</div>
		        	</div>
		        	<div class="form-group">
			        	<label class="col-md-4 control-label">Thời Gian(Tháng)</label>
			        	<div class="col-md-8">
			        		<input name="thoigian" class="form-control" type="number" value="${hopdong.getThoigian() }">
			        	</div>
		        	...
		        	<div class="form-group">
			        	...
			        	<div class="col-md-8">
			        		<input name="tungay" class="form-control" type="date" value="${hopdong.getTungay() }" >
			        	</div>
		        	...
		        	<div class="form-group">
			        	...
			        	<div class="col-md-8">
			        		<input name="denngay" class="form-control" type="date" value="${hopdong.getDenngay() }">
			        	</div>
